        ...
        <section class="register-section">
            <div class="register-card">
                ...
                <form id="register-form">
                    ...
                    <a href="login.html" class="login-link">Already have an account? <strong>Login</strong></a>
                </form>
            </div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                        ...
                        <div class="footer-links">
                            <a href="shipping.html" class="footer-link"><i class="fas fa-truck"></SHIPPING POLICY </a>
        ...
        <script>
            ...
            function checkPasswordStrength(password) {
                ...
                if (password.length < 8) {
                    strengthDisplay.textContent = 'Password too short';
            ...
            document.getElementById('register-form').addEventListener('submit', function(e) {
                ...
                // Store username and redirect to account.html
