    ...
    <section class="search-section container my-5 py-5">
        ...
        <div class="category-container mt-3">
            <select class="category-select">
                ...
                <option value="bapestas">BAPESTAS</option>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" src="assets/images/BAPESTAS.JPG" alt="BAPESTAS premium sports shoes" />
                ...
                <div class="one col-lg-4 col-sm-12 p-0">
                    ...
                    <div class="details text-center">
                        ...
                        <button class="btn btn-dark text-uppercase add-to-cart" data-name="Goth Guitar" data-price="299.99" data-image="assets/images/GOTH GUITER.JPG">ADD TO CART</button>
                    </div>
                </div>
                <!-- THREE -->
                <div class="one col-lg-4 col-sm-12 p-0">
                ...
                <!-- TWELVE -->
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" src="assets/images/PATTEK PHILIP.JPG" alt="PATEK PHILIPPE WATCHES" />
                    <div class="details text-center">
                        <h2>PATEK PHILIPPE WATCHES</h2>
                        <p>R8000</p>
                        <div class="rating">
                            <span class="star"><i class="fas fa-star"></i></span>
                            <span class="star"><i class="fas fa-star"></i></span>
                        ...
                        <button class="btn btn-dark text-uppercase add-to-cart" data-name="PATEK PHILIPPE WATCHES" data-price="600.00" data-image="assets/images/PATTEK PHILIP.JPG">ADD TO CART</button>
                    </div>
                </div>
            </div>
