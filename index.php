    ...
    <body>
        ...
        <section id="autumn-featured" class="container my-5">
            <div class="row">
                <!-- ONE -->
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" style="max-width:80%;" src="assets/images/BAPESTAS.JPG" alt="Bapestas Sneakers" />
                    <div class="details text-center">
                        <h2>BAPESTAS</h2>
                        <div class="rating" data-rating="4">
                            <span class="star"><i class="fas fa-star"></i></span>
                ...
                <!-- FOUR -->
                <div class="one col-lg-4 col-sm-12 p-0 offset-lg-4">
                    <img class="img-fluid" style="max-width:80%;" src="assets/images/NEON BAPESTAS.JPG" alt="NEON BAPESTAS SNEAKERS" />
                    <div class="details text-center">
                        <h2>NEON BAPESTAS</h2>
                        <div class="rating" data-rating="3">
                            <span class="star"><i class="fas fa-star"></i></span>
