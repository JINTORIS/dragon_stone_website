...
<body>
        ...
        <div class="container text-center mt-5 py-5">
            ...
            <div class="row mx-auto container-fluid">
                ...
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" src="assets/images/GUCCI.JPG" alt="Gucci Glasses" />
                    <div class="details text-center">
                        ...
                        <button class="btn btn-dark text-uppercase" data-product="Gucci Glasses" data-price="199.99">SHOP NOW</button>
                    </div>
                </div>
                ...
                <div class="one col-lg-4 col-sm-12 p-0">
                    ...
                    <div class="details text-center">
                        ...
                        <button class="btn btn-dark text-uppercase" data-product="Goth Guitar" data-price="299.99">SHOP NOW</button>
                    </div>
                </div>

                <!-- THREE -->
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" src="assets/images/POLA-ROID.jpeg" alt="Polaroid Camera" />
                    <div class="details text-center">
                        <h2>CAMERAS</h2>
                        ...
                        <button class="btn btn-dark text-uppercase" data-product="Polaroid Camera" data-price="149.99">SHOP NOW</button>
                    </div>
                </div>

                <!-- FOUR -->
                <div class="one col-lg-4 col-sm-12 p-0 offset-lg-4">
                    <img class="img-fluid" src="assets/images/TOYS.JPEG" alt="Toys Collection" />
                    <div class="details text-center">
                        <h2>TOYS</h2>
                        <div class="rating" data-rating="4">
                            <span class="star"><i class="fas fa-star"></i></span>
                        ...
                        <button class="btn btn-dark text-uppercase" data-product="Toys Collection" data-price="49.99">SHOP NOW</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="watches-sale" class="mt-5 pt-5 text-center">
        <div class="container">
            ...
            <div class="row">
                <!-- One -->
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" src="assets/images/PATTEK PHILIP.JPG" alt="Patek Philippe Watch" />
                    <div class="details text-center">
                        <h2>WATCHES</h2>
                        <div class="rating" data-rating="5">
                            <span class="star"><i class="fas fa-star"></i></span>
                        ...
                        <button class="btn btn-dark text-uppercase" data-product="Patek Philippe Watch" data-price="499.99">SHOP NOW</button>
                    </div>
                </div>

                <!-- TWO -->
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" src="assets/images/FROST.JPG" alt="Frost Watch" />
                    <div class="details text-center">
                        <h2>FROST WATCHES</h2>
                        <div class="rating" data-rating="4">
                            <span class="star"><i class="fas fa-star"></i></span>
                        ...
                        <button class="btn btn-dark text-uppercase" data-product="Frost Watch" data-price="399.99">SHOP NOW</button>
                    </div>
                </div>

                <!-- THREE -->
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" src="assets/images/PATTEK ICE.JPEG" alt="Patek Ice Watch" />
                    <div class="details text-center">
                        ...
                        <button class="btn btn-dark text-uppercase" data-product="Patek Ice Watch" data-price="449.99">SHOP NOW</button>
                    </div>
                </div>

                <!-- FOUR -->
                <div class="one col-lg-4 col-sm-12 p-0">
                    <img class="img-fluid" src="assets/images/ROLLIEEE.JPEG" alt="Rolex Watch" />
                    <div class="details text-center">
                        <h2>WATCHES</h2>
                        <div class="rating" data-rating="5">
                            <span class="star"><i class="fas fa-star"></i></span>
                        ...
                        <button class="btn btn-dark text-uppercase" data-product="Rolex Watch" data-price="599.99">SHOP NOW</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="autumn-featured" class="container my-5">
        <div class="row">
            <!-- ONE -->
            <div class="one col-lg-4 col-sm-12 p-0">
                ...
                <div class="details text-center">
                    ...
                    <button class="btn btn-dark text-uppercase" data-product="Bapestas Sneakers" data-price="249.99">SHOP NOW</button>
                </div>
            </div>
            ...
            <div class="one col-lg-4 col-sm-12 p-0">
                ...
                <div class="details text-center">
                    ...
                    <button class="btn btn-dark text-uppercase" data-product="Designer Jacket" data-price="199.99">SHOP NOW</button>
                </div>
            </div>
            ...
            <div class="one col-lg-4 col-sm-12 p-0">
                ...
                <div class="details text-center">
                    ...
                    <button class="btn btn-dark text-uppercase" data-product="Green Jacket" data-price="179.99">SHOP NOW</button>
                </div>
            </div>
            ...
            <div class="one col-lg-4 col-sm-12 p-0 offset-lg-4">
                ...
                <div class="details text-center">
                    ...
                    <button class="btn btn-dark text-uppercase" data-product="NEON BAPETSA SNEAKERS" data-price="269.99">SHOP NOW</button>
                </div>
            </div>
        </div>
        <!-- 5IVE -->
